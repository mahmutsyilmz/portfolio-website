...
const Footer = () => {
  ...
  return (
    <motion.footer 
      ...
      className="bg-white dark:bg-gray-900 py-6 relative overflow-hidden"
    >
      {/* Gradient Overlay */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-center">
            ...
            >
              © {currentYear} Mahmut Sami Yılmaz. All rights reserved.
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        ...
        animate={{ scaleX: 1 }}
        transition={{ duration: 0.5 }}
        className="h-[2px] bg-gradient-to-r from-transparent via-blue-500 to-transparent mt-6"
      />
    </motion.footer>
  );
};
